...
function MainHeader() {
	...
	const handleOpenMenu = () => {
		setNavClass(
			'absolute top-0 left-0 z-10 flex h-full w-4/5 cursor-pointer flex-col gap-y-5 bg-white p-8 font-bold md:static md:mr-auto md:flex md:h-auto md:flex-row md:gap-4 md:p-0 '
		);
	};
